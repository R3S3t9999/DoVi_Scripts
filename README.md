...
- Python libraries to install: Open a command window and paste: '' pip install opencv-python colour-science scikit-image matplotlib numpy colour opencv-python-headless PyQt5 OpenImageIO plotly ''   **if the heatmap workflow still fails, install Python 3.9 as well.
